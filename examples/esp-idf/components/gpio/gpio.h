...
#define RADIO_CS GPIO_NUM_42
#define RADIO_CLK GPIO_NUM_40
#define RADIO_MOSI GPIO_NUM_45
#define RADIO_MISO GPIO_NUM_46
#define RADIO_RESET GPIO_NUM_39 
#define RADIO_BUSY GPIO_NUM_41
#define RADIO_IRQ GPIO_NUM_38
#define RADIO_LED GPIO_NUM_NC
